export const modelPlaceholder =
    '# Model = (S, I, T, F) # Type \'this\' to use this main.java.model or \'compact\' for compact\n' +
    'S = {s1> [!p !q], s2 [!p q],\n' +
...
export const compactModelPlaceholder =
    '# Type \'compact\' to use this main.java.model\n' +
...
export const algorithmURL = 'http://localhost:4000'
